class AssetsManager {
  ...
  static String productsImagesPath = "assets/images/products";

// general images
  static String forgotPasswordImage = "$imagesPath/forgot_password_image.png";
  ...
  static String profileImagePlaceholder =
      "https://static.vecteezy.com/system/resources/previews/005/374/842/large_2x/male-silhouette-neon-light-icon-gentlemen-wc-door-glowing-sign-men-s-clothes-department-store-isolated-illustration-isolated-on-brick-wall-vector.jpg";
  // Bag
  ...
  //products
  static String productImage = "$imagesPath/shoes.png";
}
